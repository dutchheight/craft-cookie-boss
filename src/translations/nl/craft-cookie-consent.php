...
/**
 * Craft Cookie consent en Translation
 *
 * Returns an array with the string to be translated (as passed to `Craft::t('craft-cookie-consent', '...')`) as
...
return [
    ...
    'For more info visit our' => 'Bezoek voor meer info onze',
